classdef motor < handle 
    ...
    properties (Constant, Hidden)
       ...
       MOTORPATHDEFAULT='C:\Users\omer\Desktop\idil\MATLAB\thorlab64\'
       ...
       %STEPMOTORDLL='Thorlabs.MotionControl.TCube.StepperMotorCLI.dll';
       STEPMOTORDLL='Thorlabs.MotionControl.IntegratedStepperMotorsCLI.dll';
        ...
        function connect(h,serialNo)  % Connect device
            ...
            if ~h.isconnected
                switch(serialNo(1:2))
                    ...
                    case '45'   % Serial number corresponds to a LTS150 
        ...
        function loaddlls() % Load DLLs
            if ~exist(motor.DEVICEMANAGERCLASSNAME,'class')
                try   % Load in DLLs if not already loaded
                    ...
                    NET.addAssembly([motor.MOTORPATHDEFAULT,motor.STEPMOTORDLL]);
